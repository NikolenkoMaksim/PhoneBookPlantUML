...
public class PhoneBookControllerImpl implements PhoneBookController {
    private static final Logger logger = LoggerFactory.getLogger(PhoneBookControllerImpl.class);
    ...
    public PhoneBookControllerImpl(ContactDtoToContactConverter contactDtoToContactConverter, ContactToContactDtoConverter contactToContactDtoConverter, ContactService contactService) {
